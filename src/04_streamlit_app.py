...
MODEL_PATH = ROOT / "models" / "yolo11" / "best.pt"
model = YOLO(MODEL_PATH)


#Modifica Glory
# --- Cambia il nome della scheda del browser ---
st.set_page_config(
    page_title="Vitra",
    layout="wide"  # Layout a tutta larghezza
)

# --- CARICARE IL LOGO DA FILE LOCALE ---
logo_path = ROOT / "docs" / "project_logo.png"
logo_base64 = base64.b64encode(logo_path.read_bytes()).decode()


# --- Sfondo ---
#bg_path = Path("sfondo.png")
#bg_base64 = base64.b64encode(bg_path.read_bytes()).decode()



# --- CSS per sfondo + logo centrato ---
st.markdown(f"""
<style>
    /* Logo centrato */
    .logo-container {{
...
<div class="logo-container">
    <img src="data:image/png;base64,{logo_base64}" alt="Vitra Logo">
</div>
...
# /mnt/c/Users/galbisini
print("Visualizza il percorso")
print(ROOT)
API_KEY_PATH  = ROOT / "secrets" / "key.txt"
print("API_KEY_PATH:" , API_KEY_PATH)
CHROMA_PATH   = ROOT / "models" / "chroma_db"
print("CHROMA_PATH:", CHROMA_PATH)
PDF_DIR       = ROOT / "data" / "raw" / "rag_documents"
print("PDF_DIR:", PDF_DIR)


# Vediamo se funziona la chiamata al modello 
# Lettura chiave API da file 
...
#   )
#    print("Chiamata riuscita! Risposta del modello:")
#    print(response.choices[0].message.content)
#except Exception as e:
#    print("Errore durante la chiamata al modello:", e)


# La chiave funziona chiamata ok 
...
def rag_answer_chroma(
    ...
    # 1) Product detection
    # Usa la funzione che abbiamo visto prima (detect_product_in_query) per capire se la query menziona un prodotto specifico.
    ...
    q_emb = embedder.encode(question, convert_to_numpy=True)  #La domanda dell’utente viene trasformata in un vettore numerico.
...
uploaded_image = st.file_uploader("Carica la tua immagine", type=["jpg", "jpeg", "png"])
